...
function createTransporter() {
  return nodemailer.createTransport({
    ...
    port: 587,        // STARTTLS — works on Railway (465/SSL is blocked)
    secure: false,    // false = STARTTLS upgrade after connect
    family: 4,        // Force IPv4 — avoids Railway IPv6 ENETUNREACH errors
    auth: {
      user: process.env.SMTP_USER,
      pass: process.env.SMTP_PASS,
    },
    tls: {
      rejectUnauthorized: false, // tolerate self-signed certs in some envs
    },
  });
}
